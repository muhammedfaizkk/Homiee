            ...
            <div className=' max-999:hidden flex flex-col gap-[200px]'>
                <div className='flex justify-end '>
                    <div className='product-1 flex w-[60%]  items-center bg-primary rilative'>
                        ...
                        <div className='flex-1  pl-[100px] py-[65px] pr-[180px] max-1084:py-[25px] max-1165:py-[35px] max-1220:py-[50px] max-1234:pl-[130px] min-1233:pr-[180px] max-1328:py-[80px] max-1328:px-[160px]'>
                ...
                <div className='flex'>
                    <div className='product-1 flex w-[60%]  items-center bg-primary rilative'>
                        ...
                        <img className='flex-1 absolute right-[480px] max-1649:right-[380px] w-[25%] max-1084:right-[280px] max-1220:right-[300px]' src="./assets/images/Temeric.png" alt="" />
                    </div>
                </div>
